...
ActiveRecord::Schema.define(version: 2022_01_11_020014) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "high_edu_level"
    t.date "graduated_in"
    t.string "marital_status"
    t.boolean "children"
    t.boolean "child_dependent"
    t.string "live_in"
    t.boolean "res_com"
    t.string "com_addr_1"
    t.string "com_addr_2"
    ...
    t.string "org_city"
    t.string "org_state"
    t.string "past_employment_type"
    t.string "past_postion"
    t.date "past_emp_from"
    t.date "past_emp_to"
    t.string "past_org_addr_1"
    t.string "past_org_addr_2"
    t.string "past_org_zip"
    t.string "past_org_city"
    t.string "past_org_state"
    t.float "base_income"
    t.float "overtime_income"
    t.float "bonuses"
    t.float "commissions"
    t.float "divident_interest_income"
    t.float "net_rental_income"
    t.float "other_income"
    t.float "housing_expense"
    t.float "rent_expense"
    t.string "first_mortgage"
    t.float "other_fin_expense"
    t.float "hazard_insur_exp"
    t.float "real_estate_tax_exp"
    t.float "mort_ins_exp"
    t.float "hoa"
    t.float "child_care_exp"
    t.float "union_due_exp"
    t.float "other_exp"
    t.float "bank_assets"
    t.float "credit_uni_assets"
    t.float "stock_value"
    t.float "bonds_value"
    t.float "lic"
    t.float "real_estate_owned"
    t.float "vested_int_assests"
    t.float "retirement_fund"
    t.float "networth_of_business"
    t.float "other_liquid"
    t.float "other_nonliquid"
    t.float "alimony_liability"
    t.float "child_support_liability"
