...
class UserAccountMailer < ApplicationMailer
  ...
  def clique_payment_success
    ...
    # mail to: @professional.email, cc: ApplicationHelper::TEAM_MEBERS_EMAIL + ['rameshkbdm@gmail.com'], subject: t("clique.payment_email_subject.#{@professional.plan_type}")
    mail to: @professional.email, cc: ['rameshkbdm@gmail.com'], subject: t("clique.payment_email_subject.#{@professional.plan_type}")
  end

  def clique_payment_success_notify_to_cher
    @professional = params[:user]
    puts @professional.email
    mail to: ApplicationHelper::TEAM_MEBERS_EMAIL, subject: t("clique.payment_email_subject.#{@professional.plan_type}")
