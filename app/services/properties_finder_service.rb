...
class PropertiesFinderService
  ...
  def search_properties
    ...
    if properties_data.blank?
      ...
      properties = (PropertiesLocalInformationAppenderService.new(parsed_data['properties']).execute).sort_by { |price| price['listPrice'] }
  ...
  def fetch_from_simplyrets
    ...
    properties = properties_data[:properties].sort_by { |price| price['listPrice'] }
